...
const Formulario = ({ aoCadastrar, times, aoCriarTime }) => {
    ...
    const aoSubmeter = (evento) => {
        ...
        console.log('form enviado', nome, cargo, imagem, time, habilidade )
        aoCadastrar({
            nome,
            cargo,
            imagem,
    ...
    return (
        <section className="formulario-container">
            <form className="formulario" onSubmit={aoSubmeter}>
                <h2>Preencha os dados para criar o card do seu Char.</h2>
                <Campo
                    obrigatorio={true}
                    label='Nome'
            ...
            <form className="formulario" onSubmit={(evento) => {
                ...
                <h2>Preencha os dados para criar uma nova raça.</h2>
                <Campo
                    obrigatorio={true}
                    label='Nome'
